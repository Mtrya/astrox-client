...
# ///
"""
Compute access using J2Position for satellite.

This example demonstrates access computation with a satellite entity
using J2Position (J2 perturbation model) for orbit propagation.
